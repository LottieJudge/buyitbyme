const navigation = {
  ...
  social: [
    ...
    { name: 'YouTube', href: '#', icon: props => <svg fill="currentColor" viewBox="0 0 24 24" {...props}><path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" /></svg> }
  ]
};
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start">
          <div className="md:w-1/2">
            <nav aria-label="Footer" className="flex flex-wrap justify-center md:justify-start gap-x-12 gap-y-3 text-sm/6">
            ...
            <div className="mt-20 flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-3 text-sm/6">
        ...
        <div className="md:mt-0 md:w-1/2 md:max-w-md">
          ...
          <form className="mt-6 sm:flex sm:max-w-md">
            ...
            <input
              ...
              autoComplete="email"
              className="w-full min-w-0 rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[#191265] sm:w-64 sm:text-sm/6 xl:w-full"
            />
            <div className="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
              <button
                type="submit"
                className="flex w-full items-center justify-center rounded-md bg-[#191265] px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-[#567C8D] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          <p className="justify-center items-center mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0">
            &copy; 2025 Buy it by me, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
